...
public class GovernmentGatewayTest {
	...
	/**
	 * Test for {@link request.GovernmentGateway#sendProject(ads.Project)}
	 * @throws IOException
	...
	/**
	 * Test for {@link request.GovernmentGateway#checkProject(ads.Project)}
	 * @throws IOException
	 * @throws InvalidRequestException
	...
	public void testCheckProject() throws IOException, InvalidRequestException, InvalidIDException {
		...
		// Check the status of a project that wasnt sent
		...
		CCGG.getGateway().testIOException(2, false);
		GovernmentGateway.getInstance().sendProject(p);
